...
const Footer = () => {
  ...
  return (
    <footer className='max-w-7xl mx-auto bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 rounded-2xl my-4 shadow-2xl shadow-blue-900/20 border border-blue-800/30 backdrop-blur-xl px-4'>
      <div className='flex flex-col md:flex-row justify-between items-center p-6 text-white space-y-0 md:space-y-0'>
        ...
        <div className='flex flex-col items-center md:items-end space-y-2'>
          ...
          <p className='text-sm text-slate-300'>{t('footer.email_label')} naghiyev.ef@gmai.com</p>
          <p className='text-sm text-slate-300'>{t('footer.phone_label')} +994 55 555 33 05</p>
          ...
          <div className='flex space-x-4 mt-4'>
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/global-finance-company-az/about/" target="_blank" rel="noopener noreferrer" className='text-slate-200 hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1' aria-label="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 fill-current" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/audit_academy_?igsh=MWljbWt5c2ZocHQwcw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className='text-slate-200 hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1' aria-label="Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 fill-current" viewBox="0 0 24 24">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/994555553305" target="_blank" rel="noopener noreferrer" className="text-slate-200 hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1" aria-label="WhatsApp">
